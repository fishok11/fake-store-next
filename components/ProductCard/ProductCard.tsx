...
const ProductCard: FC<ProductCardProps> = ({id, image, title, price}) => {
      ...
      <div className={styles.container}>
        <Link href={`/product/${id}`} className={styles.link}>
          <div className={styles.imageContainer}>
            <Image src={image} alt={styles.title} className={styles.image} width={128} height={150}/> 
          </div>
  ...
  return (
    <div className={styles.container}>
      <Link href={`/product/${id}`} className={styles.link}>
        <div className={styles.imageContainer}>
          <Image src={image} alt={styles.title} className={styles.image} width={128} height={128}/> 
        </div>
        <p className={styles.title}>{title}</p>
          <div className={styles.actionContainer}>
          <p className={styles.price}>$ {price}</p>
